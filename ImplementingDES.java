...
class ImplementingDES { 
    ...
    { 
        ...
        String InputForDESEncryption = s.nextLine();
        String KeyForDESEncryption = cipher.getAlphaNumericString(16);
        String hexvalue = cipher.ASCIItoHEX(InputForDESEncryption);
        ...
        for(int i=0;i<NewHexValue.length();i=i+16)
        {
            ...
            EncryptedText[i] = cipher.encrypt(text, KeyForDESEncryption);
        }
        String DESCipherTextGenerated="";
        for(int i=0;i<NewHexValue.length();i=i+16)
        {
            DESCipherTextGenerated = DESCipherTextGenerated+EncryptedText[i];
        }
        System.out.println("\nEncryption : \n\nCipher Key Generated : \n\n"+KeyForDESEncryption+"\n\nCiphertext Generated : \n\n"+DESCipherTextGenerated);
        

        //DECRYPTION STARTS HERE
        String InputForDESDecryption = DESCipherTextGenerated;
        String KeyForDESDecryption = KeyForDESEncryption;
        String[] BlocksOfCipherText = new String[100000];
        String[] DecryptedText = new String[100000];
        for(int i=0;i<InputForDESDecryption.length();i=i+16)
        {
            BlocksOfCipherText[i] = InputForDESDecryption.substring(i, i+16);
            String text = BlocksOfCipherText[i];
            DecryptedText[i] = cipher.decrypt(text, KeyForDESDecryption); 
        }
        String CombinedDecryptedText="";
        for(int i=0;i<InputForDESDecryption.length();i=i+16)
        {
            CombinedDecryptedText = CombinedDecryptedText+DecryptedText[i];
        }
        String OriginalPlaintextRecovered = cipher.hexToASCII(CombinedDecryptedText);
        System.out.println("\nDecryption : \n\nOriginal Plaintext recovered : \n");
        System.out.println(OriginalPlaintextRecovered);
    } 
} 